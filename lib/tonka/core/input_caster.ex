defmodule Tonka.Core.InputCaster do
  ...
  # @moduledoc """
  # This behaviour describes a special kind of `Tonka.Core.Action` that must
  ...
  # will be passed as input to all grid actions that have `:incast` in their
  # `:inputs` mapping.
  # """
  ...
  # @callback call(term, Action.params(), injects :: map) :: Action.op_out()
